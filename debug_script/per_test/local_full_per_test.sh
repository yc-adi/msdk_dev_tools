...
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# NOTE:
#    1. ~/Workspace/ci_config/RF-PHY-closed.json must be correctly modified for this test.
#    2. The configuration used test name: local_full_per_test
#    3. Tools/Bluetooth must be matched with the checkout version.
#
